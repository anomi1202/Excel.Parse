...
insert into table1 (field_string, field_int, field_date, field_timestamp, field_time, field_function, field_decimal_to_string) values (NULL, 300000, '1000-01-01', '1000-01-01 00:00:00', '00:00:00', mod(3000, 10), '3000');
commit;
